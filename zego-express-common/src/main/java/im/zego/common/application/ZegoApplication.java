...
public class ZegoApplication extends MultiDexApplication {
    ...
    public static Context zegoApplication;
    public static String cosmosID;

    static public void onCreate(Context context, String cosmosId) {
        zegoApplication = context;
        cosmosID = cosmosId;
...
         */
        CrashReport.UserStrategy strategy = new CrashReport.UserStrategy(zegoApplication);
...
            It is recommended to set it to true during the testing phase and false when publishing. */
        CrashReport.initCrashReport(zegoApplication, "d53f2eacfe", false);
    }
}
