...
public class ZGVideoRenderTypeUI extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ZegoExpressEngine.createEngine(GetAppIDConfig.appID, GetAppIDConfig.appSign, SettingDataUtil.getEnv(), SettingDataUtil.getScenario(), this.getApplication(), null);
