...
import im.zego.customrender.ZegoBeautyManager;
...
public class Renderer implements TextureView.SurfaceTextureListener {
    ...
    private ZegoBeautyManager zegoBeautyManager;
    ...
    public Renderer(EGLContext eglContext, EGLDisplay eglDisplay, EGLConfig eglConfig) {
        ...
        zegoBeautyManager = new ZegoBeautyManager(ZegoApplication.zegoApplication, ZegoApplication.cosmosID);
    }
...
//            }
            ...
            int beautyTexture = zegoBeautyManager.renderWithYUVTexture(yuvTextures, pixelBuffer.width, pixelBuffer.height, true);
            mRgbDrawer.drawRgb(beautyTexture, flipMatrix, pixelBuffer.width, pixelBuffer.height, value[0], value[1], value[2], value[3]);
//            mDrawer.drawYuv(yuvTextures, flipMatrix, pixelBuffer.width, pixelBuffer.height, value[0], value[1], value[2], value[3]);
            ...
            // 渲染rgb格式图像
            // Render RGB image
            int beautyTexture = zegoBeautyManager.renderWithTexture(mTextureId, pixelBuffer.width, pixelBuffer.height, true);
            mRgbDrawer.drawRgb(beautyTexture, flipMatrix, pixelBuffer.width, pixelBuffer.height, value[0], value[1], value[2], value[3]);
            // 交换渲染好的buffer 去显示
            swapBuffers();
            // 分离当前eglContext
