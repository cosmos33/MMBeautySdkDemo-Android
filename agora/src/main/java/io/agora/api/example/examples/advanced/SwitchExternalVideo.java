...
//        index = 6,
//        group = ADVANCED,
//        name = R2.string.item_switchexternal,
//        actionId = R2.id.action_mainFragment_to_SwitchExternalVideo,
//        tipsId = R2.string.switchexternalvideo
//)
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_join) {
            ...
            try {
                ...
                intent.putExtra(ExternalVideoInputManager.FLAG_COSMOSID, AgoraApplication.cosmosAppid);
