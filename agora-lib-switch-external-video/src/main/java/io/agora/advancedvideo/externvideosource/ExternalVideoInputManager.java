...
public class ExternalVideoInputManager implements IVideoSource {
    ...
    public static final String FLAG_COSMOSID = "flag-cosmosid";
    ...
    boolean setExternalVideoInput(int type, Intent intent) {
        ...
        switch (type) {
            case TYPE_LOCAL_VIDEO:
                input = new LocalVideoInput(context, intent.getStringExtra(FLAG_VIDEO_PATH), intent.getStringExtra(FLAG_COSMOSID));
                if (TEXTUREVIEW != null) {
