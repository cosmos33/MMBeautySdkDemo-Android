...
public class LocalVideoInput implements IExternalVideoInput, TextureView.SurfaceTextureListener {
    ...
    private final AgoraBeautyManager agoraBeautyManager;
    ...
    public LocalVideoInput(Context context, String filePath, String cosmosAppid) {
        mFilePath = filePath;
        agoraBeautyManager = new AgoraBeautyManager(context, cosmosAppid);
    }
    ...
    public int onFrameAvailable(GLThreadContext context, int textureId, float[] transform) {
        ...
        int outTexture = agoraBeautyManager.renderWithOESTexture(textureId, mVideoHeight, mVideoWidth
                , true, 0);
