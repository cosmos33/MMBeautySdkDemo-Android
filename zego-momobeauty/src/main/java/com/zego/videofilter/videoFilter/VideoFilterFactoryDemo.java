...
public class VideoFilterFactoryDemo extends ZegoVideoFilterFactory {
    ...
    public VideoFilterFactoryDemo(FilterType filterType_surfaceTexture, ZegoBeautyManager zegoBeautyManager) {
        this.type = filterType_surfaceTexture;
        this.zegoBeautyManager = zegoBeautyManager;
    }
...
//                mFilter = new VideoFilterMemDemo(mFunRender);
            ...
            case FilterType_SurfaceTexture:
                mFilter = new VideoFilterSurfaceTextureDemo(zegoBeautyManager);
