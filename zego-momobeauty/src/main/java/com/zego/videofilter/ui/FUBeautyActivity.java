...
//    protected FURenderer mFURenderer;
    ...
    // cosmos美颜相关封装类
    protected ZegoBeautyManager zegoBeautyManager;
...
//        mBeautyControlView.setOnFUControlListener(mFURenderer);
    ...
    private void initSDK() {
        ...
        VideoFilterFactoryDemo filterFactory = new VideoFilterFactoryDemo(VideoFilterFactoryDemo.FilterType.FilterType_SurfaceTexture, zegoBeautyManager);
